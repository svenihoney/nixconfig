{
  ...
  wayland.windowManager.hyprland.settings.bind = ["SUPER, F10, exec, ${lib.getExe pkgs.uwsm} app -- $HOME/.nix-profile/bin/slack" "SUPER SHIFT, F10, exec, echo ozone: $NIXOS_OZONE_WL >/tmp/foo"];
