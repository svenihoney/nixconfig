...

{
  ...
  wayland.windowManager.mango = {
    ...
    settings = {
      ...
      repeat_delay = "250";
      numlockon = "0";
      xkb_rules_layout = "de,de,de";
      xkb_rules_variant = "neo_qwertz,koy,";
      ...
      bind = [
        ...
        "SUPER,Return,spawn,/home/sven/.nix-profile/bin/ghostty"
        "SUPER+SHIFT,F12,switch_keyboard_layout"
